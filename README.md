...
- The experiments specifically for **ResNet-18** and **ResNet-50** on **64x64** and **128x128** are stored in the `medmnist_resnet_nick` folder. (Please note there is another `README.md` in this folder detailing the files present and how to run the code.).
